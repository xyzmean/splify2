...
# КАЖДЫЕ сутки: 600 000 проходов PBKDF2 вместо одного раза за жизнь роутера. Сбой при этом
# тихий — пакет уезжает верный, платится только время, — и потому его никто бы не заметил.
