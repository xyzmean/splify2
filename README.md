...
интерфейсе — карточка движка на экране первого запуска, а позже на вкладке **Логи steer**. Кнопка
там ставит выбранный вариант, снимая прежний пакет; настройки при этом остаются на месте, они лежат
не в пакете. Что стоит сейчас, видно в левой колонке: `steer <версия> · extended` или `· basic`.
