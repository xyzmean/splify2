...
# Без доменных каналов force_dns = 1, как у менеджера: DNS сети заворачивает прокси.
check "без доменных каналов force_dns = 1" "1" "$(grep -c "option force_dns '1'" "$DOH_CONF")"
