 ...
 *  «проверить» было негде, оставалось ждать. Полчаса — это не больше двух походов в интернет за
 *  час на роутер, и они уходят через 1,2 с после отрисовки, ничего не задерживая. */
