...
export const rpc = {
    ...
    dohState: declare<{
        ...
        /** Системный резолвер АДРЕСОМ: второй род резолвера, живёт в dnsmasq. Пустой
         *  список — «как отдаёт провайдер», и это выбор, а не отсутствие настройки. */
        sys: string[]
    ...
    /** Системный резолвер адресом: «1.1.1.1 8.8.8.8#5353». Пусто — как отдаёт провайдер. */
    dohSysSet: declare<{ ok: boolean; error?: string }>('doh_sys_set', ['servers']),
