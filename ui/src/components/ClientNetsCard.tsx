            ...
            <CardContent className="space-y-3">
                ...
                {byNets && (
                    <div className="rounded-md border border-warning/40 bg-warning/10 p-3 text-xs">
                        <p className="text-warning-fg">
                            {/* Подсети в `from_default` — это настройки, написанные до того, как
                ...
                {anyAbsent && (
                    <p className="text-xs text-muted-foreground">
                        {/* Правило движка сверяется с именем интерфейса в момент прохода пакета,
                ...
                {chosenBad.length > 0 && (
                    <p className="text-xs text-warning-fg">
                        {/* Почему такой выбор бессмыслен: правило встаёт на пакеты, ПРИХОДЯЩИЕ с
                          * интерфейса. У выхода наружу это то, что возвращается из туннеля или
