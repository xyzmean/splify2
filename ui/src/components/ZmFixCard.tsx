 ...
 *
 *  Включено по умолчанию: он нужен именно тем, кто ещё ничего не настроил. Выключатель —
 *  потому что решение всё-таки человека: правило появляется в его правилах, и он вправе его
 *  не хотеть. */
                ...
                <div className="flex items-start gap-2.5">
                    ...
                    <div className="min-w-0">
                        ...
                        <div className="text-xs text-muted-foreground">
                            {on
                                ? t('правило появится в списке правил под именем zm_github')
