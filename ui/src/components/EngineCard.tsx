        ...
        <Card className={engine?.present && engine.vless && !tooOld ? '' : 'border-destructive'}>
            ...
            <CardContent className="space-y-3">
                ...
                {tooOld && (
                    ...
                    <p className="text-sm">
                        {`${t('Этот интерфейс собран под движок')} ${tooOld} ${t('и новее. С установленным не заработают подписка по ссылке, часть списков каталога, обход DPI как выход правила и отчёт о работе. Обновите движок — версии ниже.')}`}
                    </p>
                )}
