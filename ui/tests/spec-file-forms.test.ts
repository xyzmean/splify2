...
describe('единственная форма *_file на входе интерфейса (I-041)', () => {
    ...
    // Спор двух написаний движок больше не разрешает: с I-295 спеку с обеими формами рядом он
    // отвергает целиком (spec.c:945, :961). Интерфейс такую спеку сам не пишет, а встретив,
    // сводит к одной форме — берёт ключ, стоящий в документе ПОЗЖЕ (так решал движок до
    // I-295), и при первом сохранении файл снова становится загружаемым (I-336).
    it('при обоих написаниях остаётся одно — то, что в документе позже', async () => {
